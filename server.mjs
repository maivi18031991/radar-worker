...
import { quickLearn48h } from "./learning_engine.js";
...
const SYMBOL_MIN_VOL = Number(process.env.SYMBOL_MIN_VOL || process.env.SYMBOL_MIN_VOL_ALT || 5000000);
globalThis.SYMBOL_MIN_VOL = SYMBOL_MIN_VOL;
console.log("[DEBUG] SYMBOL_MIN_VOL =", SYMBOL_MIN_VOL);
